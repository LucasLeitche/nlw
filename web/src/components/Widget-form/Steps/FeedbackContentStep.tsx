    ...
    return (
        <>
           ...
           <footer className="flex gap-2 my-2 w-full">
                ...
                <button
                    type="submit"
                    className="p-2 bg-brand-500 rounded-md border-transparent flex flex-1 justify-center items-center text-sm hover:bg-brand-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-500 transition-colors"
                >
                    Enviar Feedback
                </button>
           </footer>
